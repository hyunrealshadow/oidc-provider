...
export class InvalidRedirectUri extends OIDCProviderError {
  error_description = formatErrorMessage('E18001');
...
export class WebMessageUriMismatch extends OIDCProviderError {
  error_description = formatErrorMessage('E19001');
...
function E(message, errorDescription, errnoType) {
  ...
  const klass = class extends OIDCProviderError {
    ...
    constructor(description, detail, errno = '999', variables = undefined) {
      super(400, message, `${errnoType}${errno}`);
      Error.captureStackTrace(this, this.constructor);

      if (typeof description === 'boolean') {
        this.error_description = formatErrorMessage(this[langIdSymbol], variables);
      }
      ...
      if (typeof detail === 'boolean') {
        this.error_detail = formatErrorMessage(this[langIdSymbol], variables);
      }
...
export const AuthorizationPending = E('authorization_pending', formatErrorMessage('E22001'), '22');
...
export const InvalidTarget = E('invalid_target', formatErrorMessage('E33002'), '33');
...
export const RegistrationNotSupported = E('registration_not_supported', formatErrorMessage('E37001'), '37');
export const RequestNotSupported = E('request_not_supported', formatErrorMessage('E38001'), '38');
export const RequestUriNotSupported = E('request_uri_not_supported', formatErrorMessage('E39001'), '39');
...
export const UnsupportedGrantType = E('unsupported_grant_type', formatErrorMessage('E47001'), '47');
export const UnsupportedResponseMode = E('unsupported_response_mode', formatErrorMessage('E48001'), '48');
export const UnsupportedResponseType = E('unsupported_response_type', formatErrorMessage('E49001'), '49');
