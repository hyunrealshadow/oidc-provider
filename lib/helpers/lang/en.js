...
export default {
  ...
  E14055: 'authorization header scheme must be `DPoP` when DPoP is used',
  ...
  E21003: 'end-user cancelled request',
  ...
  E28003: 'client secret is expired, cannot issue a JWT Authorization response',
  E28004: 'client secret is expired - cannot validate ID Token Hint',
  E28005: 'could not decrypt the Request Object - the client secret used for its encryption is expired',
  E28006: 'could not validate the Request Object - the client secret used for its signature is expired',
  E28010: (alg) => `client secret is expired - cannot issue an ID Token (${alg})`,
  E28011: (alg) => `client secret is expired - cannot issue a Logout Token (${alg})`,
  E28012: (alg) => `client secret is expired - cannot respond with ${alg} JWT UserInfo response`,
  E28013: (alg) => `client secret is expired - cannot respond with ${alg} JWT Introspection response`,
  E28014: (alg) => `client secret is expired - cannot issue an encrypted ID Token (${alg})`,
  E28015: (alg) => `client secret is expired - cannot issue an encrypted Logout Token (${alg})`,
  E28016: (alg) => `client secret is expired - cannot respond with ${alg} encrypted JWT UserInfo response`,
  E28017: (alg) => `client secret is expired - cannot respond with ${alg} encrypted JWT Introspection response`,
