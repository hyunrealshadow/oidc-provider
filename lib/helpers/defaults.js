...
async function getResourceServerInfo(ctx, resourceIndicator, client) {
  ...
  throw new errors.InvalidTarget(undefined, undefined, '002');
}
...
async function validateBindingMessage(ctx, bindingMessage) {
  ...
  if (bindingMessage && !/^[a-zA-Z0-9-._+/!?#]{1,20}$/.exec(bindingMessage)) {
    throw new errors.InvalidBindingMessage('the binding_message value, when provided, needs to be 1 - 20 characters in length and use only a basic set of characters (matching the regex: ^[a-zA-Z0-9-._+/!?#]{1,20}$ )', undefined, '001');
  }
}
...
function makeDefaults() {
  const defaults = {
    ...
    formats: {
       ...
       *
       * description: The value should be a function returning an integer and the
       ...
       *   When it is undefined, the default value is an uuid v4 formatted string.
       *
       ...
       * ```
       */
      bitsOfOpaqueRandomness: undefined,
     ...
     * errorPrefix
     *
     * description: Prefix to be used for all errors thrown by the provider.
     */
    errorPrefix: 'E',
