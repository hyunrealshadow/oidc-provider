...
export default function getContext(provider) {
  ...
  class OIDCContext extends events.EventEmitter {
    ...
    getAccessToken({
      ...
      if (!length) {
        throw new InvalidRequest(undefined, undefined, '051');
      }

      if (length > 1) {
        throw new InvalidRequest(undefined, undefined, '052');
      }

      if (!acceptQueryParam && mechanism === 'query') {
        throw new InvalidRequest(undefined, undefined, '053');
      }
      ...
      if (mechanism === 'header') {
        ...
        if (dpop && scheme.toLowerCase() !== 'dpop') {
          throw new InvalidRequest(undefined, undefined, '055');
        } else if (!dpop && scheme.toLowerCase() === 'dpop') {
          throw new InvalidRequest(undefined, undefined, '056');
        } else if (!dpop && scheme.toLowerCase() !== 'bearer') {
          throw new InvalidRequest(undefined, undefined, '057');
        }
      ...
      if (dpop && mechanism !== 'header') {
        throw new InvalidRequest(undefined, undefined, '058');
      }
