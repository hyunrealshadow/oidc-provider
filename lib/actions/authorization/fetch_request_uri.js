...
export default async function fetchRequestUri(ctx, next) {
  ...
  if (params.request_uri !== undefined) {
    ...
    try {
      ...
      throw new InvalidRequestUri(true, undefined, '001');
    }
    ...
    try {
      ...
      throw new InvalidRequestUri(true, err.message, '003');
    }
  }
