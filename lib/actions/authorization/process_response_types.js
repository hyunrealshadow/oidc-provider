...
async function tokenHandler(ctx) {
  ...
  if (Array.isArray(resource)) {
    throw new InvalidTarget('only a single resource indicator value must be requested/resolved during Access Token Request', undefined, '001');
  }
  ...
  if (resource) {
    ...
    if (!resourceServer) throw new InvalidTarget(undefined, undefined, '002');
